...
class SiteController extends Controller
{
    ...
    /*
     * array (size=5)
  'name' => string 'Nguyễn Văn Hưng' (length=19)
  'gender' => string 'male' (length=4)
  'picture' =>
    array (size=1)
      'data' =>
        array (size=2)
          'is_silhouette' => boolean false
          'url' => string 'https://scontent.xx.fbcdn.net/v/t1.0-1/p50x50/12368989_717876581682902_8057773063955092449_n.jpg?oh=90251077322b4ef98dac357514716324&oe=58BC0A11' (length=144)
  'link' => string 'https://www.facebook.com/app_scoped_user_id/916349375168954/' (length=60)
  'id' => string '916349375168954' (length=15)
     * */
